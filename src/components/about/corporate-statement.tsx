    ...
    >
      <div className="mx-auto max-w-[1320px] px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div data-about-statement>
          <p className="text-base font-semibold uppercase tracking-[0.16em] text-red-400">
            {statement.eyebrow}
          </p>
          <h2
            id="statement-title"
            className="mt-8 max-w-4xl text-balance text-4xl font-semibold uppercase leading-[1.1] tracking-[-0.01em] text-white sm:text-5xl lg:text-6xl"
          >
            {lines.length > 1 ? (
              <>
        ...
        {statement.description && (
          <p className="mt-10 max-w-3xl text-xl leading-relaxed text-white/90 whitespace-pre-line">
            {statement.description}
          </p>
        )}
      </div>

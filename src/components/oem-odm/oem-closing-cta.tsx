...
export function ClosingCta({ closing }: { closing: OemOdmClosing }) {
  return (
    <section
      id="odm-cta"
      className="relative isolate overflow-hidden bg-navy"
      aria-labelledby="odm-cta-title"
    >
      <div data-odm-cta-media className="absolute inset-0">
        <div data-odm-parallax className="absolute inset-0">
          <Image
            src={closing.image}
      ...
      <div className="relative mx-auto max-w-[1320px] px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div data-odm-cta-content className="mx-auto max-w-2xl text-center">
